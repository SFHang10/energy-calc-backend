...
console.log('🚀 Embedding 1,000-product comprehensive chunk into calculator...');

try {
    // Read the comprehensive chunk
    const comprehensiveChunk = JSON.parse(fs.readFileSync('comprehensive-chunk-1000.json', 'utf8'));
    ...
    console.log('✅ SUCCESS: Embedded 1,000-product comprehensive chunk!');
