...
console.log('🚀 Embedding 5,000-product comprehensive chunk into calculator...');

try {
    // Read the comprehensive chunk
    const comprehensiveChunk = JSON.parse(fs.readFileSync('comprehensive-chunk-5000.json', 'utf8'));
    ...
    console.log('✅ SUCCESS: Embedded 5,000-product comprehensive chunk!');
