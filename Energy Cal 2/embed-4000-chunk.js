...
console.log('🚀 Embedding 4,000-product comprehensive chunk into calculator...');

try {
    // Read the comprehensive chunk
    const comprehensiveChunk = JSON.parse(fs.readFileSync('comprehensive-chunk-4000.json', 'utf8'));
    ...
    console.log('✅ SUCCESS: Embedded 4,000-product comprehensive chunk!');
