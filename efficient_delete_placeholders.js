// Efficient batch deletion script for placeholder SKU products
// This will delete all placeholder products while preserving manual ones
...
async function deletePlaceholderProducts() {
    try {
        console.log('🚀 Starting efficient cleanup of placeholder SKU products...\n');
        ...
        const placeholderProducts = allProducts.filter(product => {
            ...
            if (MANUAL_PRODUCT_IDS.includes(product.id)) {
                return false;
            }
        ...
        for (let i = 0; i < placeholderProducts.length; i += 10) {
            ...
            // Delete products in parallel for efficiency
            ...
            if (i + 10 < placeholderProducts.length) {
