...
- [x] **W9 (partial):** Agent email preview UI + mailbox registry (`gwta@greenwaysrestaurants.com`) + SMTP send API (`/api/agent-mail`) — enable with App password + `AGENT_MAIL_SEND_ENABLED=1` on Render — 2026-09-05
