...
const { buildEnergyTickerPayload } = require('./services/energy-ticker-service');
...
const LIVE_MUSIC_DATA = [
  ...
  ['greenways-agent-mailboxes.json', path.join(__dirname, 'data', 'greenways-agent-mailboxes.json')]
];
...
app.get('/live-music/events', (req, res) => {
  ...
  const extra = qs ? (qs.includes('eventsOnly=') ? '' : '&eventsOnly=1') : '?eventsOnly=1';
  return res.redirect(302, `/live-music/render${qs}${extra}`);
});
...
app.get('/live-music/scene-status', (req, res) => {
  const qs = req.url.includes('?') ? req.url.slice(req.url.indexOf('?')) : '';
  return res.redirect(302, `/HTMLS%20GWM%20GWB/live-music-scene-status.html${qs}`);
});
...
app.get('/greenways/citizen-benefits', (req, res) => sendHtmlsFile(res, 'Citizen benefits Guide 2 update.html'));
app.get('/greenways/insulation-guide', (req, res) => sendLiveMusicHtml(res, 'Insulation .html'));
app.get('/greenways/energy-efficient-hvac', (req, res) => sendLiveMusicHtml(res, 'Energy Efficient HVAC .html'));
...
/** Wix website embed — Orchestra hub with portal family menu hidden (?embed=1 also works) */
app.get('/greenways/orchestra-hub-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-orchestra-hub.html'));
...
app.get('/greenways/agents/:slug/story-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-agent-story.html'));
...
app.get('/greenways/interactive-restaurants', (req, res) => sendLiveMusicHtml(res, 'interactive_restaurants_monitoring.html'));
  ...
  app.get('/greenways/city-energy-monitoring', (req, res) => sendLiveMusicHtml(res, 'city-energy-monitoring.html'));
app.get('/greenways/buildings-dashboard', (req, res) => sendLiveMusicHtml(res, 'Greenways Interface .html'));
app.get('/greenways/buildings-dashboard-demo', (req, res) => sendLiveMusicHtml(res, 'Greenways Interface .html'));
app.get('/greenways/buildings-dashboard-embed', (req, res) => sendLiveMusicHtml(res, 'Greenways Interface .html'));
...
app.get('/greenways/calendar', (req, res) => sendLiveMusicHtml(res, 'greenways-calendar-demo.html'));
app.get('/greenways/calendar-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-calendar-demo.html'));
...
app.get('/greenways/organisation-desk', (req, res) => sendLiveMusicHtml(res, 'greenways-organisation-desk.html'));
app.get('/greenways/organisation-desk-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-organisation-desk.html'));
...
app.get('/greenways/deals-wire', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-wire.html'));
app.get('/greenways/deals-wire-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-wire.html'));
app.get('/greenways/deals-wire-main', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-wire-main.html'));
app.get('/greenways/deals-wire-main-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-wire-main.html'));
app.get('/greenways/deals-desk', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-desk.html'));
app.get('/greenways/deals-desk-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-deals-desk.html'));
...
app.get('/greenways/restaurant-assist-demo', (req, res) => sendLiveMusicHtml(res, 'greenways-restaurant-assist-demo.html'));
app.get('/greenways/tenant-pack-idea', (req, res) => sendLiveMusicHtml(res, 'greenways-tenant-pack-idea.html'));
app.get('/greenways/tenant-pack-idea-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-tenant-pack-idea.html'));
app.get('/greenways/energy-data-journey', (req, res) => sendLiveMusicHtml(res, 'greenways-energy-data-journey.html'));
app.get('/greenways/energy-data-journey-embed', (req, res) => sendLiveMusicHtml(res, 'greenways-energy-data-journey.html'));
app.get('/greenways/site-energy-reading', (req, res) => sendLiveMusicHtml(res, 'site-energy-reading.html'));
app.get('/greenways/site-energy-reading-embed', (req, res) => sendLiveMusicHtml(res, 'site-energy-reading.html'));
...
try {
  ...
  financeWireRouter = require('./routes/finance-wire');
  ...
  agentMailRouter = require('./routes/agent-mail');
  ...
  productsWireRouter = null;
  financeWireRouter = null;
...
function mountApiRoutes() {
  ...
  if (agentVoiceRouter) {
    app.use('/api/agent-voice', agentVoiceRouter);
    console.log('✅ /api/agent-voice route mounted');
  }
  if (agentMailRouter) {
    app.use('/api/agent-mail', agentMailRouter);
    console.log('✅ /api/agent-mail route mounted');
  }
  ...
  if (financeWireRouter) {
    app.use('/api/finance-wire', financeWireRouter);
    console.log('✅ /api/finance-wire route mounted');
  }
  if (dealsAgentRouter) {
...
app.get('/api/energy-ticker', async (req, res) => {
  try {
    const payload = await buildEnergyTickerPayload();
    res.json(payload);
  } catch (error) {
