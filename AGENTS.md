...
| **Agent Market (in-agent shop)** | `HTMLS GWM GWB/greenways-agent-market.html` · `/greenways/agent-market` · module id `agent-market` · PRD `tasks/prd-agent-market.json` — deep-dive lanes + grants; browse → shortlist → buy handoff |
